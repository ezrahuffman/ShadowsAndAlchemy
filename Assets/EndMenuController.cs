...
public class EndMenuController : MonoBehaviour
{
    ...
    [SerializeField] TMP_Text _highScore_1;
    [SerializeField] TMP_Text _highScore_2;
    [SerializeField] TMP_Text _highScore_3;
    [SerializeField] TMP_Text _currTime;
    ...
    internal void OpenMenu(float time)
    {
        _menuObject.SetActive(true);
        Time.timeScale = 0;

        _currTime.text = time.ToString("F2") + " s";
